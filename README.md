...
```bash
--http --http.addr=0.0.0.0 --http.corsdomain=* --http.vhosts=* --http.port=8545 --http.api eth,txpool,net,web3,rbn --statusserver.addr=0.0.0.0 --statusserver.port=6539 --prometheus.addr=0.0.0.0 --prometheus.port=8080
```
...
- Copy the script from current github  
